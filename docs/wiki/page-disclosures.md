...
3. **Indicative commission rate schedule** — a striped data table (5 asset classes × Year-1 / Year-2+ trail ranges), all values placeholders pending AMC empanelment confirmation.
